<section class="main">
	...
	<div class="clients">
		<p class="clients__title">Clientes que confían en nosotros:</p>
		<picture>
			<source media="(min-width: 1280px)" srcset="src/assets/imgs/clientes-pc.png"/>
			<source media="(min-width: 640px)" srcset="src/assets/imgs/clientes-tablet.png"/>
			<img src="src/assets/imgs/clientes-mob.png" alt="clientes logos" class="clients__image">
		</picture>
	</div>
</section>